...
import com.ida.challengechapter5.model.ResultXX

class TopAdapter(private val onItemClick: OnClickListener):
    ...
    fun submitData(value: List<ResultXX>?) = differ.submitList(value)
